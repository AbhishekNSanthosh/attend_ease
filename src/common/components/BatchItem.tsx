...
export default function BatchItem({
  ...
  return (
    <div className="flex flex-col bg-white p-4 rounded-lg border border-azure-100 gap-5 h-[245px]">
    ...
    <div className="w-full flex flex-col space-y-2">
      <button
        onClick={() => router.push(`/dashboard/attendance/${batchCode}/mark-attendance/today`)}
        className="bg-azure-600 w-full text-white font-medium p-2 rounded-md"
      >
        Mark Today's Attendance
      </button>
      <button
        onClick={() => router.push(`/dashboard/attendance/${batchCode}/mark-attendance/custom-date`)}
